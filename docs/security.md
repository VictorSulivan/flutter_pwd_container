...
- Assistant [`/assistant`](assistant.md) : Gemini (Firebase AI), compteurs seulement
...
Le « conseil » de l’écran sécurité est un texte local. L’assistant IA ([`assistant.md`](assistant.md)) rédige le briefing avec Gemini, toujours sur des métadonnées, jamais sur le secret. Hors ligne : texte Dart.
